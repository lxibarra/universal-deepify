 ...
 * isNaN method
 */
t.isNaN=n(21)},function(e,t,n){e.exports=n(3)},function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.deepify=void 0;var o=n(15);t.deepify={mutate:!1,configure:function(e){this.mutate=e},set:function(e,t,n,r){var i=(0,o.isMutable)(r,this)?e:(0,o.deepCopy)(e);return null!==i&&(0,o.setProperty)(i,t,n),i}}},,function(e,t,n){"use strict";var o=n(39),r=n(40);describe("Test deepify",function(){it("ES-ENV working for tests",function(){var e=[1,2,3].reduce(function(e,t){return e+t},0);(0,o.expect)(e).equal(6)}),it("newely created object is not undefined",function(){var e=r.deepify.set({},"person.last","ibarra");(0,o.expect)(e.person).not.equal(void 0)}),it("set a person.last = ibarra",function(){var e=r.deepify.set({},"person.last","ibarra");(0,o.expect)(e.person.last).equal("ibarra")}),it("set deep prop country.person.last.phone = 42423432",function(){var e=r.deepify.set({},"country.person.last.phone","42423432");(0,o.expect)(e.country.person.last.phone).equal("42423432")}),it("set deep with special chars person.[$]sse = 1",function(){var e=r.deepify.set({},"person.[]sse","1");(0,o.expect)(e.person["[]sse"]).equal("1")}),it("set array prop person.phones[] with item Hello in position 0 ",function(){var e=r.deepify.set({},"person.phones[]","hello");(0,o.expect)(e.person.phones instanceof Array).equal(!0),(0,o.expect)(e.person.phones.length).equal(1),(0,o.expect)(e.person.phones[0]).equal("hello")}),it("setting array prop person.phones[3] with item 423432 results in array of 1 in length with item value 423432",function(){var e=r.deepify.set({},"person.phones[3]","423432");(0,o.expect)(e.person.phones instanceof Array).equal(!0),(0,o.expect)(e.person.phones.length).equal(1),(0,o.expect)(e.person.phones[0]).equal("423432");var t=r.deepify.set(e,"person.phones[1]","wow");console.log("OBJ2",t),(0,o.expect)(t.person.phones[0]).equal("423432"),(0,o.expect)(t.person.phones[1]).equal("wow")})})}])});
