 ...
 */
o.prototype.constructor=o,o.prototype.toJSON=function(e){var t=n("constructor","toJSON","stack")({name:this.name},this);return!1!==e&&this.stack&&(t.stack=this.stack),t}},function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0});var o="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e};t.isMutable=function(e,t){return"boolean"==typeof e?e:!(!t||"boolean"!=typeof t.mutate)&&t.mutate},t.deepCopy=function(e){return null!==e&&void 0!==e&&"object"===(void 0===e?"undefined":o(e))?JSON.parse(JSON.stringify(e)):null},t.setProperty=function(e,t,n){if(!("string"==typeof t&&t.length>0))throw"propertyName must be a string and lenght > 0";var o=t.split("."),r=o.length,i=e,s=/\[\]$/,a=/\[\d+\]$/;o.forEach(function(e,t){if(t+1===r)if(e.match(s)){var o=e.replace(s,"");i[o]=[],i[o].push(n),i=i[o]}else if(e.match(a)){var c=parseInt([].concat(function(e){if(Array.isArray(e)){for(var t=0,n=Array(e.length);t<e.length;t++)n[t]=e[t];return n}return Array.from(e)}(e.match(a)))[0].replace(/[\[\]]/gi,""),10),u=e.replace(a,"");i[u]instanceof Array?c>i[u].lenght?i[u].push(n):i[u].splice(c,0,n):i[u]=[n]}else i[e]=n;else i[e]={},i=i[e]})}},function(e,t){
/*!
 * chai
 * Copyright(c) 2011-2014 Jake Luer <jake@alogicalparadox.com>
 * MIT Licensed
